...
(async () => {
  ...
  await fs.writeFile("neonatal-jaundice-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("neonatal-jaundice-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
